...
/* package aula-0.1.0.0 */
#ifndef VERSION_aula
#define VERSION_aula "0.1.0.0"
#endif /* VERSION_aula */
#ifndef MIN_VERSION_aula
#define MIN_VERSION_aula(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_aula */
...
#define CURRENT_COMPONENT_ID "aula-0.1.0.0-JLwqTfwe7xR3WhvwhesQPY-aula"
