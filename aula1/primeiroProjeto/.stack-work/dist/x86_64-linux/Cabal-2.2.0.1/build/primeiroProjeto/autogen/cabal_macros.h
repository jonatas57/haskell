...
/* package primeiroProjeto-0.1.0.0 */
#ifndef VERSION_primeiroProjeto
#define VERSION_primeiroProjeto "0.1.0.0"
#endif /* VERSION_primeiroProjeto */
#ifndef MIN_VERSION_primeiroProjeto
#define MIN_VERSION_primeiroProjeto(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_primeiroProjeto */
...
#define CURRENT_COMPONENT_ID "primeiroProjeto-0.1.0.0-JJvBhpuGLHoCRWkCHFKXaW-primeiroProjeto"
