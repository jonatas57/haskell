...
/* package arkanoid-0.1.0.0 */
#ifndef VERSION_arkanoid
#define VERSION_arkanoid "0.1.0.0"
#endif /* VERSION_arkanoid */
#ifndef MIN_VERSION_arkanoid
#define MIN_VERSION_arkanoid(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_arkanoid */
...
#define CURRENT_COMPONENT_ID "arkanoid-0.1.0.0-JurAkwB5ivPIoxRhkxGCvC-arkanoid"
